...
export const Register = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault(); //evita que a pag seja recarrecada, p/ poder exibir erro (caso aconteça um erro)
        setError(""); //limpa qualquer mensagem de erro existente
    ...
    return (
        <div className={styles.register}>
            ...
            <p>Crie seu usuário e compartilhe suas experiências no mundo da tecnologia</p>
